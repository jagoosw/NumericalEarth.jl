...
hmu = heatmap!(axu, stats.τˣ.avg * ρ,      colormap = :balance, colorrange = (-0.2, 0.2))
hmv = heatmap!(axv, stats.τʸ.avg * ρ,      colormap = :balance, colorrange = (-0.2, 0.2))
...
hmu = heatmap!(axu, stats.τˣ.std * ρ,      colormap = :deep, colorrange = (0, 0.3))
hmv = heatmap!(axv, stats.τʸ.std * ρ,      colormap = :deep, colorrange = (0, 0.3))
...
hmu = heatmap!(axu, stats.τˣ.max * ρ,      colormap = :magma, colorrange = (0.1,  2.0))
hmv = heatmap!(axv, stats.τʸ.max * ρ,      colormap = :magma, colorrange = (0.1,  2.0))
...
hmu = heatmap!(axu, stats.τˣ.min * ρ,      colormap = :haline, colorrange = (-2.0,  0.1))
hmv = heatmap!(axv, stats.τʸ.min * ρ,      colormap = :haline, colorrange = (-2.0,  0.1))
